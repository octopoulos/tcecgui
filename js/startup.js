...
function prepare_settings() {
    ...
    merge_settings({
        ...
        graph: {
            _prefix: 'graph_',
            graph_aspect_ratio: option_number(1.25, 0.5, 5, 0.005),
        ...
        live: {
            ...
            live_pv: [ON_OFF, 1],
            move_height_live: option_number(55, 39, 1600, 0.5),
            moves_live: [ON_OFF, 1],
            show_ply: show_plies,
        },
        moves: {
            ...
            move_height: option_number(69, 3, 1600, 0.5),
            move_height_copy: option_number(260, 39, 1600, 0.5),
            move_height_live: option_number(55, 39, 1600, 0.5),
            move_height_pv: option_number(154, 65, 1600, 0.5),
        ...
        quick: {
            chat_height: option_number(850, 100, 1600, 0.5),
        ...
        copy: {
            ...
            download_PGN: '1',
            grid: option_number(0, 0, 10),
            move_height: option_number(69, 39, 1600, 0.5),
            moves: [ON_OFF, 1],
            moves_copy: [ON_OFF, 0],
        },
        copy_copy: {
        ...
        copy_pv: {
            ...
            download_PGN: '1',
            grid_pv: option_number(2, 0, 10),
            move_height_pv: option_number(154, 39, 1600, 0.5),
            moves_pv: [ON_OFF, 1],
            show_ply: show_plies,
        },
        copy_pva: {
