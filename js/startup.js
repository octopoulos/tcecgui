...
let AD_STYLES = {},
    ...
    LEVELS = {
        ...
        'engine maker': 'd=5 e=att n=1 q=12 s=ab t=5',
        'chess player': 'd=6 e=att n=1 q=15 s=ab t=10',
        'chess teacher': 'd=7 e=att n=1 q=20 s=ab t=12',
        'other engine': 'd=8 e=att n=1 q=30 s=ab t=20',
    },
    old_font_height,
    old_stream = 0,
    old_window_height,
